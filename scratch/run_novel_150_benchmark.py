"""
Runner Script: Evaluates the novel 150-case benchmark dataset (facet_evaluation_test_set_150_novel.csv)
...
def run_novel_150_benchmark():
    ...
    print("======================================================================")
    print("RUNNING NOVEL 150-CASE BENCHMARK EVALUATION SUITE")
    print("======================================================================")

    for idx, row in df_150.iterrows():
    ...
    report_path = exp_dir / "novel_150_benchmark_results.md"
    report_md = f"""# Novel 150-Case Benchmark Evaluation Report

---

## 🏆 Summary Metrics (Novel 150-Case Benchmark)
...
"""
    ...
    pd.DataFrame(case_logs).to_csv(exp_dir / "novel_150_benchmark_results.csv", index=False)

    print("\n" + "=" * 70)
    print("NOVEL 150-CASE BENCHMARK EVALUATION COMPLETE")
